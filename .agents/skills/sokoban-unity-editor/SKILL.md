...
Read only the relevant section of [UnityMcp.md](../../../Docs/Debug/UnityMcp.md):
...
For asset moves also use [ProjectStructure.md](../../../Docs/Engineering/ProjectStructure.md), “Asset moves”. Protect unsaved scenes/drafts during recovery. Inspect the resulting state and test results; fix failures introduced by the operation before completing it.
