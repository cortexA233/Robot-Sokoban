...
游戏与构建窗口标题统一为 **Robot Sokoban**，Windows 可执行文件建议命名为 `Robot Sokoban.exe`。旧版本本地进度的存放位置及迁移方法见 [玩家进度](Docs/UI/UIImplementation.md#玩家进度)。
...
1. 打开 **Robot Sokoban > Level Editor**，点击“新建”，或从“示例关卡”打开已有地图。新图默认 9×9，可调整尺寸、生成边界墙。
