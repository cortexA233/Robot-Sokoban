...
当前已具备作者工具基础、三关连续游玩，以及基于 KToolkit 的简约 UGUI 菜单、HUD、选关、暂停、结算与设置，尚未达到 GDD 的完整 Take-home 交付标准。

- 打开 **Sokoban_Tools > Level Editor**，左侧选择 L01/L02/L03 或 LAB01，再点击“试玩并录制”。
...
- 直接打开 `Assets/Scenes/Bootstrap.unity` 并 Play 进入主菜单。“开始游戏”经幕布过渡进入 L01；“选择关卡”先选择条目，再点击“进入关卡”。三关均可直接选择。
- 通关后点击“下一关”进入 L02/L03；Esc 暂停页可选关、设置或返回主菜单。L03 通关显示“空间站已重启”，可返回选关或重玩。切关会重置本关计数与撤销记录。
