...
用户随后明确指定新的 [v0.8.0 收尾版本](Versions/V0.8.0Closeout.md)，已规划 R11：选关状态留空或仅显示“已完成 · N 步”，删除推动次数及“所有关卡均可选择”；追加 R12：删除已注释 MenuItem 对应的编辑器工具，已核对 10 项/9 个脚本及关联入口，保留在用资源与共享功能。本次仅登记需求；同号旧引导计划仍已取消，原范围不恢复。
