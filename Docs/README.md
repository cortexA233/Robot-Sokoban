...
后续工作已按 [迭代路线图](Versions/Roadmap.md) 分配到 v0.4.0–v0.9.0：依次为编辑器与目录、镜头与场景美术、UI 与进度、简单音效/BGM、引导与难度、完整交付验收。[v0.4.0](Versions/V0.4.0.md)、[v0.5.0](Versions/V0.5.0.md) 已完成，其余四个版本仍为已规划；下一执行版本为 [v0.6.0](Versions/V0.6.0.md)。默认俯视、V 切换、局部遮挡及连接配色的 [v0.5.0 验收与演示](Versions/V0.5.0Validation/README.md) 已记录。[v0.4.1](Versions/V0.4.1.md) 补充了 v0.6.0 的 UI 简化要求：取消关卡标题、目标提示、完成文案配置及对应 UI。
