...
后续需求已在 [迭代路线图](Versions/Roadmap.md) 排入 v0.4.0–v0.9.0 六个版本。v0.4.0、v0.5.0、v0.6.0 已完成，下一执行版本为 v0.7.0；v0.7.0–v0.9.0 保持已规划。
...
2. **操作与音频反馈**：角色表情气泡和音效等；玩家进度、最佳成绩、继续入口及设置持久化已实现，音效/BGM 归 v0.7.0。
